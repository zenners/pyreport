...
stringFormat = {'font':'Segeo UI', 'font_size': '7', 'align': 'left'}
...
@app.route("/pagessss", methods=['GET'])
def page():
    output = BytesIO()
    ...
    # df.to_excel(writer, startrow=7, merge_cells=False, index=False, sheet_name="Variables", header=None)
    ...
    worksheet3.set_h_pagebreaks(range(0, 3000, 50))
...
def collectionreport():
    ...
    header1 = '&L&"Arial,Bold"&20RFSC' + '&RDate Generated: &D' + '&L\n\nCOLLECTION SUMMARY' + \
              '&L\n\n\nPeriod: {}-{}'.format(startDateFormat(dateStart), endDateFormat(dateEnd)) + '&R\nGenerated By: {}'.format(
        name) + '&R\n\nTime Generated: &T' + '&L\n\n\n\nNationwide' + '&R\n\n\nPage &P of &N'

    worksheet.set_landscape()
    worksheet.set_margins(top=1.3)
    worksheet.print_area('A6:V{}'.format(count + 1))

    worksheet.fit_to_pages(1, 0)
    worksheet.repeat_rows(5, 6)
    worksheet.set_header(header1)
    worksheet.set_start_page(2)
    worksheet.set_h_pagebreaks(range(7, 3000, 36))
    worksheet.set_h_pagebreaks(range(7, 3000, 36))
...
def accountingAgingReport():
    ...
    agingp2headers = ["PRINCIPAL", "INTEREST", "PENALTY"]
    ...
    header1 = '&L&"Arial,Bold"&20RFSC' + '&RDate Generated: &D' + '&L\n\nAGING REPORT' + \
              '&L\n\n\nAs of {}'.format(startDateFormat(date)) + '&R\nGenerated By: {}'.format(
        name) + '&R\n\nTime Generated: &T' + '&L\n\n\n\nNationwide' + '&R\n\n\nPage &P of &N'

    worksheetAgingP1.set_landscape()
    worksheetAgingP1.set_margins(top=1.3)
    worksheetAgingP1.print_area('A6:AE{}'.format(count1 + 1))

    worksheetAgingP1.fit_to_pages(1, 0)
    worksheetAgingP1.repeat_rows(5, 6)
    worksheetAgingP1.set_header(header1)
    worksheetAgingP1.set_h_pagebreaks(range(7, 3000, 36))
...
def newmemoreport():
    ...
    header1 = '&L&"Arial,Bold"&20RFSC' + '&RDate Generated: &D' + '&L\n\nMemo Report (Credit)' + \
              '&L\n\n\nPeriod: {}-{}'.format(dateStart, dateEnd) + '&R\nGenerated By: {}'.format(
        name) + '&R\n\nTime Generated: &T' + '&L\n\n\n\nNationwide' + '&R\n\n\nPage &P of &N'

    worksheetCredit.set_landscape()
    worksheetCredit.set_margins(top=1.3)
    worksheetCredit.print_area('A6:O{}'.format(countCredit + 1))

    worksheetCredit.fit_to_pages(1, 0)
    worksheetCredit.repeat_rows(5, 6)
    worksheetCredit.set_header(header1)
    ...
    worksheetDebit.set_landscape()
    worksheetDebit.set_margins(top=1.3)
    worksheetDebit.print_area('A6:O{}'.format(countCredit + 1))

    worksheetDebit.fit_to_pages(1, 0)
    worksheetDebit.repeat_rows(5, 6)
    worksheetDebit.set_header(header1)
...
def tat():
    ...
    worksheetStandard.set_landscape()
    worksheetStandard.set_margins(top=1.3)
    worksheetStandard.print_area('A6:S{}'.format(countStandard + 1))

    worksheetStandard.fit_to_pages(1, 0)
    worksheetStandard.repeat_rows(5, 6)
    worksheetStandard.set_header(header1)
    ...
    header1 = '&L&"Arial,Bold"&20RFSC' + '&RDate Generated: &D' + '&L\n\nTAT Report (Returned)' + \
              '&L\n\n\nPeriod: {}-{}'.format(startDateFormat(dateStart),
                                             endDateFormat(dateEnd)) + '&R\nGenerated By: {}'.format(
        name) + '&R\n\nTime Generated: &T' + '&L\n\n\n\nNationwide' + '&R\n\n\nPage &P of &N'

    worksheetReturned.set_landscape()
    worksheetReturned.set_margins(top=1.3)
    worksheetReturned.print_area('A6:X{}'.format(countReturned + 1))

    worksheetReturned.fit_to_pages(1, 0)
    worksheetReturned.repeat_rows(5, 6)
    worksheetReturned.set_header(header1)
...
def get_uabalances():
    ...
    worksheet.set_landscape()
    worksheet.set_margins(top=1.3)
    worksheet.print_area('A6:H{}'.format(count + 1))
...
def get_data1():
    ...
    header1 = '&L&"Arial,Bold"&20RFSC' + '&RDate Generated: &D' + '&L\n\nDAILY CASH/CHECK COLLECTION REPORT' + \
              '&L\n\n\nPeriod: {}-{}'.format(startDateFormat(dateStart),
                                             endDateFormat(dateEnd)) + '&R\nGenerated By: {}'.format(
        name) + '&R\n\nTime Generated: &T' + '&L\n\n\n\nNationwide' + '&R\n\n\nPage &P of &N'
    ...
    worksheet.set_landscape()
    worksheet.set_margins(top=1.3)
    worksheet.print_area('A6:P{}'.format(counts + 27))
...
def get_monthly1():
    ...
    number = [number + 1 for number in range(7, 3000, 35)]
    # print('number', number)
    # print('number 0', number[0])


    row_number = 35
    # row_value = ['', '', '','SUB TOTAL:',"=SUM(E{}:E{})".format(number[0] , number[0] + 34),0,0,0,0,'','']

    if row_number > df.index.max() + 1:
        print("Invalid row_number")
    else:
        for i in range(7, 100, 35):
            # print('AY', i)
            print('AY +', i + 28)
            row_value = ['', '', '', 'SUB TOTAL:', "=SUM(E{}:E{})".format(i + 1, i + 35), 0, 0, 0, 0, '', '']
            df = Insert_row(i+28, df, row_value)
    ...
    header1 = '&L&"Arial,Bold"&20RFSC' + '&RDate Generated: &D' + '&L\n\nMonthly Income Report' + \
              '&L\n\n\nFor the month of {}'.format(month) + '&R\nGenerated By: {}'.format(name) + '&R\n\nTime Generated: &T' + '&L\n\n\n\nNationwide' + '&R\n\n\nPage &P of &N'

    worksheet.set_landscape()
    worksheet.set_margins(top=1.3)
    worksheet.print_area('A6:K{}'.format(count + 1))
    ...
    dataframeStyle(worksheet, 'A', 'B', 8, count, workbookFormat(workbook, defaultFormat))
    dataframeStyle(worksheet, 'C', 'D', 8, count, workbookFormat(workbook, stringFormat))
    dataframeStyle(worksheet, 'E', 'K', 8, count, workbookFormat(workbook, numFormat))
...
def get_booking():
    ...
    worksheet.set_landscape()
    worksheet.set_margins(top=1.3)
    worksheet.print_area('A6:Z{}'.format(count + 1))
...
def get_incentive():
    ...
    header1 = '&L&"Arial,Bold"&20RFSC' + '&RDate Generated: &D' + '&L\n\nSales Referral Report' + \
              '&L\n\n\nPeriod: {}-{}'.format(startDateFormat(dateStart), endDateFormat(dateEnd)) + '&R\nGenerated By: {}'.format(
        name) + '&R\n\nTime Generated: &T' + '&L\n\n\n\nNationwide' + '&R\n\n\nPage &P of &N'

    worksheet.set_landscape()
    worksheet.set_margins(top=1.3)
    worksheet.print_area('A6:M{}'.format(count + 1))
...
def get_mature():
    ...
    header1 = '&L&"Arial,Bold"&20RFSC' + '&RDate Generated: &D' + '&L\n\nMatured Loans Report' + \
              '&L\n\n\nAs of {}'.format(startDateFormat(date)) + '&R\nGenerated By: {}'.format(
        name) + '&R\n\nTime Generated: &T' + '&L\n\n\n\nNationwide' + '&R\n\n\nPage &P of &N'

    worksheet.set_landscape()
    worksheet.set_margins(top=1.3)
    worksheet.print_area('A6:N{}'.format(count + 1))
