...
def workSheet(workbook, worksheet, range1, range2, range3, xldate_header, name, reportTitle):
    ...
    worksheet.merge_range('A4:{}4'.format(range1), 'Head Office', merge_format1)
    ...
    worksheet.merge_range('{}4:{}4'.format(range2, range3), 'Page - -', merge_format5)
...
def get_booking():
    ...
    if df.empty:
        ...
        otherFeesum = pd.Series(df['otherFees']).sum()
    ...
    worksheet.merge_range('J6:J7', 'OMA', merge_format7)
    worksheet.merge_range('K6:K7', 'Term', merge_format7)
    worksheet.merge_range('L6:L7', 'Rate', merge_format7)
    worksheet.merge_range('M6:M7', 'MI', merge_format7)
    worksheet.merge_range('N6:N7', 'Booking Date', merge_format7)
    worksheet.merge_range('O6:O7', 'Approval Date', merge_format7)
    worksheet.merge_range('P6:P7', 'Application Date', merge_format7)
    worksheet.merge_range('Q6:Q7', 'Branch', merge_format7)
    worksheet.merge_range('R6:R7', 'Promo Name', merge_format7)
    ...
    worksheet.write('J{}'.format(count + 1), otherFeesum, merge_format4)
    worksheet.write('M{}'.format(count + 1), monthlyAmountsum, merge_format4)
