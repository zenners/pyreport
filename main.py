...
def collectionreport():
    ...
    merge_format1 = workbook.add_format({'align': 'left'})
    merge_format2 = workbook.add_format({'bold': True, 'align': 'left'})
    merge_format3 = workbook.add_format({'bold': True, 'align': 'left', 'font_size': '14'})
    merge_format4 = workbook.add_format({'bold': True, 'align': 'right', 'num_format': '₱#,##0.00'})
    merge_format5 = workbook.add_format({'align': 'right'})
    merge_format6 = workbook.add_format({'bold': True, 'bottom': 2, 'align': 'center'})
    merge_format7 = workbook.add_format({'bold': True, 'align': 'center', 'valign': 'vcenter', 'border': True})
    ...
    worksheet.merge_range('A1:R1', 'RFSC', merge_format3)
    worksheet.merge_range('A2:R2', 'Collection Report', merge_format2)
    worksheet.merge_range('A3:R3', xldate_header, merge_format1)
    worksheet.merge_range('A4:R4', 'Head Office', merge_format1)

    worksheet.merge_range('S1:U1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheet.merge_range('S2:U2', 'Generated By: {}'.format(name), merge_format5)
    worksheet.merge_range('S3:U3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheet.merge_range('S4:U4', 'Page - -', merge_format5)
    ...
    worksheet.merge_range('D6:D7', 'AMT DUE', merge_format7)
    worksheet.merge_range('E6:E7', 'DD', merge_format7)
    worksheet.merge_range('F6:F7', 'PNV', merge_format7)
    worksheet.merge_range('G6:G7', 'MLV', merge_format7)
    worksheet.merge_range('H6:H7', 'MI', merge_format7)
    worksheet.merge_range('I6:I7', 'Term', merge_format7)
    worksheet.merge_range('J6:J7', 'PEN', merge_format7)
    worksheet.merge_range('K6:K7', 'INT', merge_format7)
    worksheet.merge_range('L6:L7', 'PRIN', merge_format7)
    worksheet.merge_range('M6:M7', 'UNPAID MOS.', merge_format7)
    worksheet.merge_range('N6:N7', 'PAID MOS.', merge_format7)
    ...
    worksheet.merge_range('S6:S7', 'OB', merge_format7)
    worksheet.merge_range('T6:T7', 'STATUS', merge_format7)
    worksheet.merge_range('U6:U7', 'TOTAL PAYMENT', merge_format7)

    worksheet.merge_range('A{}:U{}'.format(count - 1, count - 1), nodisplay, merge_format6)
    worksheet.merge_range('A{}:B{}'.format(count, count), 'GRAND TOTAL:', merge_format2)
    worksheet.write('D{}'.format(count), amountDuesum, merge_format4)
    worksheet.write('F{}'.format(count), pnvsum, merge_format4)
    worksheet.write('G{}'.format(count), mlvsum, merge_format4)
    worksheet.write('H{}'.format(count), misum, merge_format4)
    worksheet.write('J{}'.format(count), sumOfPenaltysum, merge_format4)
    worksheet.write('S{}'.format(count), outstandingBalancesum, merge_format4)
    worksheet.write('U{}'.format(count), totalPaymentsum, merge_format4)
...
def accountingAgingReport():
    ...
    if df.empty:
        ...
        count = df.shape[0] + 8
        nodisplay = ''
        todaysum = pd.Series(df['today']).sum()
        sum1 = pd.Series(df['1-30']).sum()
        sum31 = pd.Series(df['31-60']).sum()
        sum61 = pd.Series(df['61-90']).sum()
        sum91 = pd.Series(df['91-120']).sum()
        sum121 = pd.Series(df['121-150']).sum()
        sum151 = pd.Series(df['151-180']).sum()
        sum181 = pd.Series(df['181-360']).sum()
        sum360 = pd.Series(df['360 & over']).sum()
    ...
    worksheet.merge_range('A1:P1', 'RFSC', merge_format3)
    worksheet.merge_range('A2:P2', 'Accounting Aging Report', merge_format2)
    worksheet.merge_range('A3:P3', xldate_header, merge_format1)
    worksheet.merge_range('A4:P4', 'Head Office', merge_format1)

    worksheet.merge_range('Q1:S1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheet.merge_range('Q2:S2', 'Generated By: {}'.format(name), merge_format5)
    worksheet.merge_range('Q3:S3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheet.merge_range('Q4:S4', 'Page - -', merge_format5)

    worksheet.merge_range('A6:A7', 'Collector', merge_format7)
    worksheet.merge_range('B6:B7', "Client's Name", merge_format7)
    worksheet.merge_range('C6:C7', 'Mobile Number', merge_format7)
    worksheet.merge_range('D6:D7', 'Address', merge_format7)
    worksheet.merge_range('E6:E7', 'Loan Acct. #', merge_format7)
    worksheet.merge_range('F6:F7', 'Today', merge_format7)
    worksheet.merge_range('G6:G7', '1-30', merge_format7)
    worksheet.merge_range('H6:H7', '31-60', merge_format7)
    worksheet.merge_range('I6:I7', '61-90', merge_format7)
    worksheet.merge_range('J6:J7', '91-120', merge_format7)
    worksheet.merge_range('K6:K7', '121-150', merge_format7)
    worksheet.merge_range('L6:L7', '151-180', merge_format7)
    worksheet.merge_range('M6:M7', '181-360', merge_format7)
    worksheet.merge_range('N6:N7', '360 & OVER', merge_format7)
    worksheet.merge_range('O6:O7', 'Total', merge_format7)
    worksheet.merge_range('P6:P7', 'Matured', merge_format7)
    worksheet.merge_range('Q6:Q7', 'Due Principal', merge_format7)
    worksheet.merge_range('R6:R7', 'Due Interest', merge_format7)
    worksheet.merge_range('S6:S7', 'Due Penalty', merge_format7)
    ...
    worksheet.write('F{}'.format(count + 1), todaysum, merge_format4)
    worksheet.write('G{}'.format(count + 1), sum1, merge_format4)
    worksheet.write('H{}'.format(count + 1), sum31, merge_format4)
    worksheet.write('I{}'.format(count + 1), sum61, merge_format4)
    worksheet.write('J{}'.format(count + 1), sum91, merge_format4)
    worksheet.write('K{}'.format(count + 1), sum121, merge_format4)
    worksheet.write('L{}'.format(count + 1), sum151, merge_format4)
    worksheet.write('M{}'.format(count + 1), sum181, merge_format4)
    worksheet.write('N{}'.format(count + 1), sum360, merge_format4)
...
def operationAgingReport():
    ...
    if df.empty:
        ...
        pnvsum = pd.Series(df['PNV']).sum()
        mlvsum = pd.Series(df['MLV']).sum()
        bpnvsum = pd.Series(df['bPNV']).sum()
        bmlvsum = pd.Series(df['bMLV']).sum()
        misum = pd.Series(df['mi']).sum()
        notduesum = pd.Series(df['notDue']).sum()
        todaysum = pd.Series(df['today']).sum()
        sum1 = pd.Series(df['1-30']).sum()
        sum31 = pd.Series(df['31-60']).sum()
        sum61 = pd.Series(df['61-90']).sum()
    ...
    worksheet.merge_range('A1:Y1', 'RFSC', merge_format3)
    worksheet.merge_range('A2:Y2', 'Operations Aging Report', merge_format2)
    worksheet.merge_range('A3:Y3', xldate_header, merge_format1)
    worksheet.merge_range('A4:Y4', 'Head Office', merge_format1)

    worksheet.merge_range('Z1:AB1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheet.merge_range('Z2:AB2', 'Generated By: {}'.format(name), merge_format5)
    worksheet.merge_range('Z3:AB3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheet.merge_range('Z4:AB4', 'Page - -', merge_format5)

    worksheet.merge_range('A6:A7', 'App ID', merge_format7)
    worksheet.merge_range('B6:B7', 'Loan Acct. #', merge_format7)
    worksheet.merge_range('C6:C7', "Client's Name", merge_format7)
    worksheet.merge_range('D6:D7', 'Mobile Number', merge_format7)
    worksheet.merge_range('E6:E7', 'Address', merge_format7)
    worksheet.merge_range('F6:F7', 'Term', merge_format7)
    worksheet.merge_range('G6:G7', 'FDD', merge_format7)
    worksheet.merge_range('H6:H7', 'Status', merge_format7)
    worksheet.merge_range('I6:I7', 'PNV', merge_format7)
    worksheet.merge_range('J6:J7', 'MLV', merge_format7)
    worksheet.merge_range('K6:K7', 'bPNV', merge_format7)
    worksheet.merge_range('L6:L7', 'bMLV', merge_format7)
    worksheet.merge_range('M6:M7', 'MI', merge_format7)
    worksheet.merge_range('N6:N7', 'NOT DUE', merge_format7)
    worksheet.merge_range('O6:O7', 'Matured', merge_format7)

    worksheet.merge_range('P6:P7', 'Today', merge_format7)
    worksheet.merge_range('Q6:Q7', '1-30', merge_format7)
    worksheet.merge_range('R6:R7', '31-60', merge_format7)
    worksheet.merge_range('S6:S7', '61-90', merge_format7)
    worksheet.merge_range('T6:T7', '91-120', merge_format7)
    worksheet.merge_range('U6:U7', '121-150', merge_format7)
    worksheet.merge_range('V6:V7', '151-180', merge_format7)
    worksheet.merge_range('W6:W7', '181-360', merge_format7)
    worksheet.merge_range('X6:X7', '360 & OVER', merge_format7)
    worksheet.merge_range('Y6:Y7', 'Total', merge_format7)
    worksheet.merge_range('Z6:Z7', 'Due Principal', merge_format7)
    ...
    worksheet.write('I{}'.format(count + 1), pnvsum, merge_format4)
    worksheet.write('J{}'.format(count + 1), mlvsum, merge_format4)
    worksheet.write('K{}'.format(count + 1), bpnvsum, merge_format4)
    worksheet.write('L{}'.format(count + 1), bmlvsum, merge_format4)
    worksheet.write('M{}'.format(count + 1), misum, merge_format4)
    worksheet.write('N{}'.format(count + 1), notduesum, merge_format4)

    worksheet.write('P{}'.format(count + 1), todaysum, merge_format4)
    worksheet.write('Q{}'.format(count + 1), sum1, merge_format4)
    worksheet.write('R{}'.format(count + 1), sum31, merge_format4)
    worksheet.write('S{}'.format(count + 1), sum61, merge_format4)
    worksheet.write('T{}'.format(count + 1), sum91, merge_format4)
    worksheet.write('U{}'.format(count + 1), sum121, merge_format4)
    worksheet.write('V{}'.format(count + 1), sum151, merge_format4)
    worksheet.write('W{}'.format(count + 1), sum181, merge_format4)
    worksheet.write('X{}'.format(count + 1), sum360, merge_format4)
...
def newmemoreport():
    ...
    worksheetCredit.merge_range('A1:K1', 'RFSC', merge_format3)
    worksheetCredit.merge_range('A2:K2', 'Memo Report', merge_format2)
    worksheetCredit.merge_range('A3:K3', xldate_header, merge_format1)
    worksheetCredit.merge_range('A4:K4', 'Head Office', merge_format1)

    worksheetCredit.merge_range('L1:N1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheetCredit.merge_range('L2:N2', 'Generated By: {}'.format(name), merge_format5)
    worksheetCredit.merge_range('L3:N3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheetCredit.merge_range('L4:N4', 'Page - -', merge_format5)
    ...
    worksheetDebit.merge_range('A1:K1', 'RFSC', merge_format3)
    worksheetDebit.merge_range('A2:K2', 'Memo Report', merge_format2)
    worksheetDebit.merge_range('A3:K3', xldate_header, merge_format1)
    worksheetDebit.merge_range('A4:K4', 'Head Office', merge_format1)

    worksheetDebit.merge_range('L1:N1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheetDebit.merge_range('L2:N2', 'Generated By: {}'.format(name), merge_format5)
    worksheetDebit.merge_range('L3:N3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheetDebit.merge_range('L4:N4', 'Page - -', merge_format5)
...
def tat():
    ...
    worksheetStandard.merge_range('A1:O1', 'RFSC', merge_format3)
    worksheetStandard.merge_range('A2:O2', 'Operations Aging Report', merge_format2)
    worksheetStandard.merge_range('A3:O3', xldate_header, merge_format1)
    worksheetStandard.merge_range('A4:O4', 'Head Office', merge_format1)

    worksheetStandard.merge_range('P1:R1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheetStandard.merge_range('P2:R2', 'Generated By: {}'.format(name), merge_format5)
    worksheetStandard.merge_range('P3:R3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheetStandard.merge_range('P4:R4', 'Page - -', merge_format5)
    ...
    worksheetReturned.merge_range('A1:T1', 'RFSC', merge_format3)
    worksheetReturned.merge_range('A2:T2', 'Turn Around Time Report', merge_format2)
    worksheetReturned.merge_range('A3:T3', xldate_header, merge_format1)
    worksheetReturned.merge_range('A4:T4', 'Head Office', merge_format1)

    worksheetReturned.merge_range('U1:W1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheetReturned.merge_range('U2:W2', 'Generated By: {}'.format(name), merge_format5)
    worksheetReturned.merge_range('U3:W3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheetReturned.merge_range('U4:W4', 'Page - -', merge_format5)
...
def get_uabalances():
    ...
    worksheet.merge_range('A1:D1', 'RFSC', merge_format3)
    worksheet.merge_range('A2:D2', 'Unapplied Balance Report', merge_format2)
    worksheet.merge_range('A3:D3', xldate_header, merge_format1)
    worksheet.merge_range('A4:D4', 'Head Office', merge_format1)

    worksheet.merge_range('E1:G1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheet.merge_range('E2:G2', 'Generated By: {}'.format(name), merge_format5)
    worksheet.merge_range('E3:G3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheet.merge_range('E4:G4', 'Page - -', merge_format5)
...
def get_data():
    ...
    worksheet.merge_range('A1:D1', 'RFSC', merge_format3)
    worksheet.merge_range('A2:D2', 'Daily Cash/Check Collection Report', merge_format2)
    worksheet.merge_range('A3:D3', xldate_header, merge_format1)
    worksheet.merge_range('A4:D4', 'Head Office', merge_format1)
    ...
    worksheet.merge_range('B6:B7', "Client's Name", merge_format7)
    worksheet.merge_range('C6:C7', "Mobile Number", merge_format7)
    worksheet.merge_range('D6:D7', 'OR #', merge_format7)
    worksheet.merge_range('E6:E7', 'OR Date', merge_format7)
    worksheet.merge_range('F6:F7', 'Net Cash', merge_format7)
    worksheet.merge_range('G6:G7', 'Payment Source', merge_format7)
...
def get_data1():
    ...
    worksheet.write('H{}'.format(count + 1, count + 1), 'GRAND TOTAL:', merge_format3)
...
def get_monthly1():
    ...
    worksheet.merge_range('A1:G1', 'RFSC', merge_format3)
    worksheet.merge_range('A2:G2', 'Monthly Income Report', merge_format2)
    worksheet.merge_range('A3:G3', xldate_header, merge_format1)
    worksheet.merge_range('A4:G4', 'Head Office', merge_format1)

    worksheet.merge_range('H1:J1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheet.merge_range('H2:J2', 'Generated By: {}'.format(name), merge_format5)
    worksheet.merge_range('H3:J3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheet.merge_range('H4:J4', 'Page - -', merge_format5)
...
def get_booking():
    ...
    worksheet.merge_range('A1:N1', 'RFSC', merge_format3)
    worksheet.merge_range('A2:N2', 'Booking Report', merge_format2)
    worksheet.merge_range('A3:N3', xldate_header, merge_format1)
    worksheet.merge_range('A4:N4', 'Head Office', merge_format1)

    worksheet.merge_range('O1:Q1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheet.merge_range('O2:Q2', 'Generated By: {}'.format(name), merge_format5)
    worksheet.merge_range('O3:Q3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheet.merge_range('O4:Q4', 'Page - -', merge_format5)

    worksheet.merge_range('A6:A7', 'App ID', merge_format7)
    worksheet.merge_range('B6:B7', "Loan Acct. #", merge_format7)
    worksheet.merge_range('C6:C7', "Client's Name", merge_format7)
    worksheet.merge_range('D6:D7', 'Sub Product', merge_format7)
    worksheet.merge_range('E6:E7', 'PNV', merge_format7)
    worksheet.merge_range('F6:F7', 'MLV', merge_format7)
    worksheet.merge_range('G6:G7', 'Finance Fee', merge_format7)
    worksheet.merge_range('H6:H7', 'CGLI', merge_format7)
    worksheet.merge_range('I6:I7', 'Handling Fee', merge_format7)
    worksheet.merge_range('J6:J7', 'Term', merge_format7)
    worksheet.merge_range('K6:K7', 'Rate', merge_format7)
    worksheet.merge_range('L6:L7', 'MI', merge_format7)
    worksheet.merge_range('M6:M7', 'Booking Date', merge_format7)
    worksheet.merge_range('N6:N7', 'Approval Date', merge_format7)
    worksheet.merge_range('O6:O7', 'Application Date', merge_format7)
    worksheet.merge_range('P6:P7', 'Branch', merge_format7)
    worksheet.merge_range('Q6:Q7', 'Promo Name', merge_format7)

    worksheet.merge_range('A{}:Q{}'.format(count, count), nodisplay, merge_format6)
    worksheet.merge_range('A{}:B{}'.format(count + 1, count + 1), 'GRAND TOTAL:', merge_format2)
...
def get_incentive():
    ...
    worksheet.merge_range('A1:I1', 'RFSC', merge_format3)
    worksheet.merge_range('A2:I2', 'Sales Referral Report', merge_format2)
    worksheet.merge_range('A3:I3', xldate_header, merge_format1)
    worksheet.merge_range('A4:I4', 'Head Office', merge_format1)

    worksheet.merge_range('J1:L1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheet.merge_range('J2:L2', 'Generated By: {}'.format(name), merge_format5)
    worksheet.merge_range('J3:L3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheet.merge_range('J4:L4', 'Page - -', merge_format5)
...
def get_mature():
    ...
    worksheet.merge_range('A1:J1', 'RFSC', merge_format3)
    worksheet.merge_range('A2:J2', 'Unapplied Balance Report', merge_format2)
    worksheet.merge_range('A3:J3', xldate_header, merge_format1)
    worksheet.merge_range('A4:J4', 'Head Office', merge_format1)

    worksheet.merge_range('K1:M1', 'Date Generated: {}'.format(dateNow), merge_format5)
    worksheet.merge_range('K2:M2', 'Generated By: {}'.format(name), merge_format5)
    worksheet.merge_range('K3:M3', 'Time Generated: {}'.format(timeNow), merge_format5)
    worksheet.merge_range('K4:M4', 'Page - -', merge_format5)
