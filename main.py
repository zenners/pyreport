...
def collectionreport():
    ...
    headers = ["App Id", "Mobile No", "Loan Account No", "Customer Name", "Email", "FDD", "DD", "PNV", "MLV", "MI", "TERM",
    ...
    worksheet.merge_range('P{}:Q{}'.format(count + 1, count + 1), 'TOTAL PAYMENT', merge_format3)
    worksheet.write('R{}'.format(count + 1), sum, merge_format4)
...
def get_data1():
    ...
    # return jsonify(greater_than_zero)
        ...
        df['advance'] = df['total'] - df['pipTotal']
    ...
    worksheet.merge_range('A1:O1', 'RADIOWEALTH FINANCE COMPANY, INC.', merge_format3)
    worksheet.merge_range('A2:O2', 'RFC360 Kwikredit', merge_format1)
    worksheet.merge_range('A3:O3', 'Daily Cash Collection Report', merge_format3)
    worksheet.merge_range('A4:O4', xldate_header, merge_format1)
